export default {
  ...
  manager: {
    ...
    feeHigh: 'Abu Dhabi / Al Ain fee',
    feeLow: 'Other emirates fee',
    ...
    defaultFee: 'Default fee (other areas)',
    zonesTitle: 'Delivery zones',
    zoneLabel: 'Zone name',
    zoneKeywords: 'City keywords (comma-separated)',
    zoneKeywordsHint: 'Any city containing one of these words uses this zone fee',
    zoneFee: 'Fee',
    addZone: 'Add zone',
    noZones: 'No zones yet.',
    zoneErr: 'Zone name and fee are required',
    logout: 'Sign out',
    ...
    compressImages: 'Compress product images',
    compressDone: 'Compressed {n} images — the list loads faster now',
    compressNone: 'No images need compressing',
